...
const ControllerPlugin_1 = require("./plugin/ControllerPlugin");
const ConfigsPlugin_1 = require("./plugin/ConfigsPlugin");
const api_service_pages_1 = require("api-service-pages");
const config = require("config");
// configure a new chassis
let chassis = new api_service_core_1.Chassis(config, api_service_common_1.default_features);
// register our custom plugin
chassis.registerPlugin(new ControllerPlugin_1.ControllerPlugin());
chassis.registerPlugin(new ConfigsPlugin_1.ConfigsPlugin());
chassis.registerPlugin(new api_service_mongo_1.MongoStore());
chassis.registerPlugin(new api_service_pages_1.MarkdownPlugin());
chassis.registerFn(new api_service_pages_1.PlantUML());
chassis.registerFn(new api_service_pages_1.Markdown());
// start the Chassis ...
chassis.start();
