...
class GenericK8sWatcher {
    constructor() {
    }
    install(context, kc, options) {
        ...
        RR(folder, [], (err, files) => {
            if (!err && files) {
                _.each(files, (file) => {
                    ...
                    this.maybeHandleResource("added", yaml);
                });
            }
        });
    }
     ...
     * @param spec
     */
    maybeHandleResource(action, spec) {
...
exports.default = GenericK8sWatcher;
//# sourceMappingURL=GenericK8sWatcher.js.map